...
// unshift - 배열의 가장 앞에 요소를 추가하고 return은 배열의 길이
console.log(numbers.unshift('a'))
console.log(numbers)

// shift - 배열의 앞의 요소 제거 후 return
console.log(numbers.shift())
console.log(numbers)

// boolean return - 있으면 true, 없으면 false
...
console.log(numbers.indexOf('b')) // -1 -> 찾고자 하는 요소가 없으면 -1를 return
